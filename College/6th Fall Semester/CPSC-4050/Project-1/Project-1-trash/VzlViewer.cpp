...
#include <cmath>
#include "VzlViewer.h"
#include </usr/local/Cellar/libomp/12.0.1/include/omp.h>
...
//      Rotate up direction
    ...
    void
    VzlViewer::SetCameraEyeViewUp(float eyex, float eyey, float eyez, float viewx, float viewy, float viewz, float upx,
                                  float upy, float upz) {
        camera_eye_x = eyex;
        camera_eye_y = eyey;
        camera_eye_z = eyez;
